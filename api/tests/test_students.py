...
class UserTestCase(unittest.TestCase):
    ...
    def test_students(self):
        ...
        admin_signup_data = {
            "first_name": "Blank",
            "last_name": "Admin",
            "email": "blankadmin@gmail.com",
            "password": "password"
        }

        response = self.client.post('/admin/register', json=admin_signup_data)

        admin = Admin.query.filter_by(email='blankspace@gmail.com').first()
        ...
        student_signup_data = {
            "first_name": "Blank",
            "last_name": "Student",
            "email": "blankstudent@gmail.com",
            "password": "password",
            "matric_no": "JBCH/13/02/0001"
        }

        response = self.client.post('/students/register', json=student_signup_data, headers=headers)

        student = Student.query.filter_by(email='blankstudent@gmail.com').first()

        assert student.first_name == "Blank"

        assert student.matric_no == "JBCH/13/02/0001"
        ...
        assert response.json == {
            "grade_id": 1,
            "student_id": 2,
            "student_first_name": "Blank",
            "student_last_name": "Student",
            "student_matric_no": "JBCH/13/02/0001",
            "course_id": 1,
